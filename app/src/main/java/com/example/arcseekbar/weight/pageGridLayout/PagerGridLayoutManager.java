...
package com.example.arcseekbar.weight.pageGridLayout;
...
public class PagerGridLayoutManager extends RecyclerView.LayoutManager
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        Loge("Item onLayoutChildren");
        Loge("Item onLayoutChildren isPreLayout = " + state.isPreLayout());
        Loge("Item onLayoutChildren isMeasuring = " + state.isMeasuring());
    ...
    private void recycleAndFillItems(RecyclerView.Recycler recycler, RecyclerView.State state,
        ...
        Loge("mOffsetX = " + mOffsetX);
        Loge("mOffsetY = " + mOffsetY);
    ...
    public void onScrollStateChanged(int state) {
        Loge("onScrollStateChanged = " + state);
        mScrollState = state;
    ...
    private Rect getItemFrameByPosition(int pos) {
        ...
        if (null == rect) {
            ...
            // 状态输出，用于调试
            Loge("pagePos = " + pagePos);
            Loge("行 = " + row);
            Loge("列 = " + col);

            Loge("offsetX = " + offsetX);
            Loge("offsetY = " + offsetY);
    ...
    private int getPageIndexByOffset() {
        ...
        Loge("getPageIndexByOffset pageIndex = " + pageIndex);
        return pageIndex;
    }
